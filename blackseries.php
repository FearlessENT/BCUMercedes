...
<div id = "title" class = "title">
    ...
    <h1>AMG Black Series Performance </h1>

    <h2>View our limited Black Series cars below</h2>
</div>
...
<div id = "homeslide" class = "homeslide">
    <img src = "images/blackseries.jpg">
</div>
...
// search query 
$sql = "SELECT * from cars WHERE blackseries = 'yes' ";
